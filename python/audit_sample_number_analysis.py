...
class SampleStatisticsSimulation:
    ...
    def compute_statistics(self, true_p, *args, **kwargs):
        ...
        power, dsample_power = audit_simulation.power\
            (true_p, dsample=True, *args, **kwargs)
    ...
    def extract_statistics(dsample, m):
        ...
        statistics["mean"] = mean + (1 - cumulative_probability) * m
...
if __name__ == "__main__":
    ...
    sss = SampleStatisticsSimulation(audit_method, 5000, 0.9, True)
    summary = None
    if test_mode == 0:
